                        ...
                        <form role="form" method="post" action="invite_add_do.php">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="code_sub" placeholder="小于8个字符"  >
                                </div>

                                <div class="form-group">
                                    <label for="cate_title">邀请码类别</label>
                                    <input type="text" class="form-control" name="code_type"  placeholder="0为公开，其他数字为对应用户的UID" >
                                </div>

                                <div class="form-group">
                                    <label for="cate_title">邀请码数量</label>
                                    <input  type="text"  class="form-control" name="code_num" placeholder="要生成的邀请码数量"  >
                                </div>
