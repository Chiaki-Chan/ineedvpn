...
<head>
    ...
    <link href="../Public/asset/css/flat-ui.css" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="../Public/asset/css/sticky-footer-navbar.css" rel="stylesheet">
...
<footer class="footer">
    <div class="container">
        <p class="text-muted"><strong>Copyright &copy; <?php echo date('Y'); ?> <a href="../../"><?php echo $site_name;  ?></a>.</strong> All rights reserved. Powered by  <b>素問</b> <?php echo $version; ?> </p>
    </div>
</footer>
