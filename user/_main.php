...
<head>
    ...
    <link href="/Public/asset/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="/Public/asset/materialize/css/materialize.mins.css" type="text/css" rel="stylesheet" media="screen,projection"/>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="index.php" class="logo waves-effect waves-light"><?php echo $site_name;  ?></a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation">
            <!-- Sidebar toggle button-->
            <a href="#" class="sidebar-toggle waves-effect waves-light" data-toggle="offcanvas" role="button">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="update.php" class="btn btn-info btn-sm waves-effect waves-light blue">个人信息</a>
                                </div>
                                <div class="pull-right">
                                    <a href="logout.php" class="btn btn-info btn-sm waves-effect waves-light green">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li >
                    <a href="update.php">
                        <i class="fa  fa-pencil"></i> <span>我的信息</span>
                    </a>
                </li>
