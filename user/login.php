    ...
    <div class="login-box">
        <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <input id="email" name="Email" type="text" class="form-control" placeholder="手機號"/>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        ...
                        <button id="login" type="submit" class="btn-large waves-effect waves-light blue">登录</button>
                  </div>
